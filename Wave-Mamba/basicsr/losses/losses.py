...
class L_Abs_pure(nn.Module):
    """L1 loss for flare prediction.

    Used in flare removal: L1(flare_pred, gt_flare) where gt_flare = input - gt_clean
    """
    def __init__(self, loss_weight=1.0):
...
class L_percepture(nn.Module):
    ...
    Args:
        loss_weight (float): Weight for perceptual loss. Default: 1.0.
    """
    def __init__(self, loss_weight=1.0):
    ...
    def forward(self, source, target):
        ...
        return self.loss_weight * perceptual_loss, None
